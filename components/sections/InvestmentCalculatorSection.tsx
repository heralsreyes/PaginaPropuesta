  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="p-6 sm:p-8 theme-card-glass backdrop-blur-md shadow-2xl border text-white space-y-6 relative overflow-hidden">
          {/* Subtle ambient glow */}
          <div className="absolute -top-24 -right-24 w-72 h-72 bg-[var(--secondary-accent)]/5 blur-3xl rounded-full pointer-events-none" />
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-white/10 pb-4 relative z-10">
            <div className="flex flex-col items-start text-left">
              <span className="text-[11px] font-medium tracking-widest uppercase theme-text-color mb-1 flex items-center gap-2 font-mono">
                <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
                <span>CONTROL DINÁMICO DE VALORES</span>
              </span>
              <div className="flex items-center gap-2.5">
                <SlidersHorizontal className="w-5 h-5 theme-accent-color" />
                <h3 className="font-bold text-lg sm:text-xl text-white theme-h1-color font-display tracking-tight">
            ...
            <div className="flex items-center gap-2">
              <span className="text-xs font-mono font-medium theme-text-color">Modo Interés:</span>
              <button
                ...
                className={`px-3.5 py-1.5 rounded-lg text-xs font-mono font-medium transition-all cursor-pointer select-none ${
                  calcCompound
                    ? "bg-[var(--secondary-accent)] text-white shadow-md shadow-[var(--secondary-accent)]/25 scale-105"
                    : "bg-white/5 hover:bg-white/10 theme-text-color border border-white/10"
                }`}
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 relative z-10">
            ...
            <div className="space-y-2 bg-white/[0.02] hover:bg-white/[0.04] p-4 rounded-xl border border-white/10 transition-all shadow-sm">
              <div className="flex justify-between items-center text-xs font-mono">
                <span className="theme-text-color">1. Capital Inicial:</span>
                <span className="font-bold text-white theme-h1-color text-sm">${calcAmount.toLocaleString()} USD</span>
              </div>
              <input
                type="range"
                min="10000"
                ...
                className="w-full accent-[var(--secondary-accent)] cursor-pointer h-2 bg-white/10 rounded-lg"
              />
              <span className="text-[10px] theme-text-color font-mono block">$10k a $1,000,000 USD</span>
            </div>

            {/* Slider 2: Tasa Anual Retorno */}
            <div className="space-y-2 bg-white/[0.02] hover:bg-white/[0.04] p-4 rounded-xl border border-white/10 transition-all shadow-sm">
              <div className="flex justify-between items-center text-xs font-mono">
                <span className="theme-text-color">2. Tasa Anual:</span>
                <span className="font-bold theme-accent-color text-sm">{customRatePercent.toFixed(1)}% p.a.</span>
              </div>
              <input
                type="range"
                min="7.5"
                ...
                className="w-full accent-[var(--secondary-accent)] cursor-pointer h-2 bg-white/10 rounded-lg"
              />
              <span className="text-[10px] theme-text-color font-mono block">Rango: 7.5% a 16.0% p.a.</span>
            </div>

            {/* Slider 3: Asignación Mutuos */}
            <div className="space-y-2 bg-white/[0.02] hover:bg-white/[0.04] p-4 rounded-xl border border-white/10 transition-all shadow-sm">
              <div className="flex justify-between items-center text-xs font-mono">
                <span className="theme-text-color">3. % Mutuos:</span>
                <span className="font-bold theme-accent-color text-sm">{mutuoWeightPercent}%</span>
              </div>
              <input
                type="range"
                min="10"
                ...
                className="w-full accent-[var(--secondary-accent)] cursor-pointer h-2 bg-white/10 rounded-lg"
              />
              <span className="text-[10px] theme-text-color font-mono block">ESAFI: {100 - mutuoWeightPercent}%</span>
            </div>

            {/* Slider 4: Plazo Estimado */}
            <div className="space-y-2 bg-white/[0.02] hover:bg-white/[0.04] p-4 rounded-xl border border-white/10 transition-all shadow-sm">
              <div className="flex justify-between items-center text-xs font-mono">
                <span className="theme-text-color">4. Plazo (Días):</span>
                <span className="font-bold theme-accent-color text-sm">{calcTermDays} días</span>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <div className="lg:col-span-5 p-6 sm:p-7 theme-card-glass backdrop-blur-md border shadow-2xl space-y-6 text-center text-white relative overflow-hidden">
            <div className="flex items-center justify-between border-b border-white/10 pb-3.5 text-left">
              <div>
                <span className="text-[11px] font-medium tracking-widest uppercase theme-text-color mb-0.5 flex items-center gap-1.5 font-mono">
                  <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
                  <span>COMPOSICIÓN ACTIVA</span>
                </span>
                <h3 className="font-bold text-base sm:text-lg text-white theme-h1-color font-display tracking-tight">
          ...
          <div className="lg:col-span-7 p-6 sm:p-7 theme-card-glass backdrop-blur-md border shadow-2xl space-y-5 text-white relative overflow-hidden">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-white/10 pb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-sm sm:text-base text-white theme-h1-color font-display tracking-tight">
                    Simulación_Inversión_Excel.xlsx
                  </h3>
                  <span className="text-xs theme-text-color font-mono">Hoja de Cálculo Viva con Fórmulas</span>
                </div>
              </div>
