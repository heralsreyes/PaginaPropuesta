    ...
    >
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-7 rounded-3xl bg-white/95 backdrop-blur-md border border-[#D8D2C2] shadow-xl shadow-[#1B7A38]/5 hover:shadow-2xl hover:border-[#1B7A38]/40 transition-all space-y-3">
        ...
        <div className="p-8 rounded-3xl bg-white/95 backdrop-blur-md border border-[#D8D2C2] shadow-xl shadow-[#1B7A38]/5 space-y-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
            <div className="p-4 rounded-2xl bg-[#F5F2E8] border border-[#DDD7C7] text-center space-y-1 hover:border-[#1B7A38]/40 transition-all">
