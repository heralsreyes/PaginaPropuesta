    ...
    >
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-7 rounded-3xl bg-[#D2D8E1] border border-[#CBD1DC] shadow-md shadow-slate-900/5 hover:shadow-xl hover:border-[#1B7A38]/40 transition-all space-y-3">
        ...
        <div className="p-8 rounded-3xl bg-[#D2D8E1] border border-[#CBD1DC] shadow-md shadow-slate-900/5 space-y-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
            <div className="p-4 rounded-2xl bg-[#C6CDD8] border border-[#BAC1CE] text-center space-y-1 hover:border-[#1B7A38]/40 transition-all">
