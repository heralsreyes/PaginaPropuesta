    ...
    >
      ...
      >
        <div className="text-center space-y-4 max-w-4xl mx-auto">
          ...
          <p className="text-base sm:text-lg text-[#224436] max-w-3xl mx-auto font-medium leading-relaxed">
            <EditableField
              id="sec10_desc"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-7 rounded-3xl bg-[#BFDAD1] border border-[#A6C5BB] shadow-lg shadow-emerald-950/5 hover:shadow-2xl hover:border-[#135A34]/40 transition-all space-y-3">
            ...
            <h3 className="font-extrabold text-xl text-[#135A34] font-display">Perfil & Trayectoria</h3>
            <p className="text-xs sm:text-sm text-[#224436] leading-relaxed font-medium">
          ...
          <div className="p-7 rounded-3xl bg-[#BFDAD1] border border-[#A6C5BB] shadow-lg shadow-emerald-950/5 hover:shadow-2xl hover:border-[#135A34]/40 transition-all space-y-3">
            ...
            <h3 className="font-extrabold text-xl text-[#135A34] font-display">Filosofía Empresarial</h3>
            <p className="text-xs sm:text-sm text-[#224436] leading-relaxed font-medium">
          ...
          <div className="p-7 rounded-3xl bg-[#BFDAD1] border border-[#A6C5BB] shadow-lg shadow-emerald-950/5 hover:shadow-2xl hover:border-[#135A34]/40 transition-all space-y-3">
            ...
            <h3 className="font-extrabold text-xl text-[#135A34] font-display">Calidad & Continuidad</h3>
            <p className="text-xs sm:text-sm text-[#224436] leading-relaxed font-medium">
        ...
        <div className="p-8 rounded-3xl bg-[#BFDAD1] border border-[#A6C5BB] shadow-lg shadow-emerald-950/5 space-y-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
            <div className="p-4 rounded-2xl bg-[#AFCFC5] border border-[#97BDB1] text-center space-y-1 hover:border-[#135A34]/40 transition-all">
              <span className="text-xs font-mono font-bold text-[#135A34] block">ISO 27001 / 27002</span>
              <span className="text-[10px] text-[#2F5242]">Seguridad de Información</span>
            </div>
            <div className="p-4 rounded-2xl bg-[#AFCFC5] border border-[#97BDB1] text-center space-y-1 hover:border-[#135A34]/40 transition-all">
              <span className="text-xs font-mono font-bold text-[#135A34] block">ISO 9001</span>
              <span className="text-[10px] text-[#2F5242]">Gestión de Calidad</span>
            </div>
            <div className="p-4 rounded-2xl bg-[#AFCFC5] border border-[#97BDB1] text-center space-y-1 hover:border-[#135A34]/40 transition-all">
              <span className="text-xs font-mono font-bold text-[#135A34] block">DAMA CDMP</span>
              <span className="text-[10px] text-[#2F5242]">Gobierno de Datos</span>
            </div>
            <div className="p-4 rounded-2xl bg-[#AFCFC5] border border-[#97BDB1] text-center space-y-1 hover:border-[#135A34]/40 transition-all">
              <span className="text-xs font-mono font-bold text-[#135A34] block">CMMI & COBIT</span>
              <span className="text-[10px] text-[#2F5242]">Ingeniería de Software</span>
            </div>
            <div className="p-4 rounded-2xl bg-[#AFCFC5] border border-[#97BDB1] text-center space-y-1 hover:border-[#135A34]/40 transition-all">
              <span className="text-xs font-mono font-bold text-[#135A34] block">ITIL v4</span>
              <span className="text-[10px] text-[#2F5242]">Gestión de Servicios</span>
            </div>
            <div className="p-4 rounded-2xl bg-[#AFCFC5] border border-[#97BDB1] text-center space-y-1 hover:border-[#135A34]/40 transition-all">
              <span className="text-xs font-mono font-bold text-[#135A34] block">Scrum / PMI</span>
              <span className="text-[10px] text-[#2F5242]">Metodología Ágil</span>
            </div>
          </div>
        </div>
      </motion.div>
