    ...
    >
      ...
      >
        <div className="text-center space-y-4 max-w-4xl mx-auto">
          ...
          <p className="text-base sm:text-lg text-[#334155] max-w-3xl mx-auto font-medium leading-relaxed">
            <EditableField
              id="sec10_desc"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-7 rounded-3xl bg-[#DADFE6] border border-[#CBD1DC] shadow-md shadow-slate-900/5 hover:shadow-xl hover:border-[#1B7A38]/40 transition-all space-y-3">
        ...
        <div className="p-8 rounded-3xl bg-[#DADFE6] border border-[#CBD1DC] shadow-md shadow-slate-900/5 space-y-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
            <div className="p-4 rounded-2xl bg-[#CFD5DF] border border-[#BFC6D4] text-center space-y-1 hover:border-[#1B7A38]/40 transition-all">
              <span className="text-xs font-mono font-bold text-[#1B7A38] block">ISO 27001 / 27002</span>
              <span className="text-[10px] text-[#475569]">Seguridad de Información</span>
            </div>
            <div className="p-4 rounded-2xl bg-[#CFD5DF] border border-[#BFC6D4] text-center space-y-1 hover:border-[#1B7A38]/40 transition-all">
              <span className="text-xs font-mono font-bold text-[#1B7A38] block">ISO 9001</span>
              <span className="text-[10px] text-[#475569]">Gestión de Calidad</span>
            </div>
            <div className="p-4 rounded-2xl bg-[#CFD5DF] border border-[#BFC6D4] text-center space-y-1 hover:border-[#1B7A38]/40 transition-all">
              <span className="text-xs font-mono font-bold text-[#1B7A38] block">DAMA CDMP</span>
              <span className="text-[10px] text-[#475569]">Gobierno de Datos</span>
            </div>
            <div className="p-4 rounded-2xl bg-[#CFD5DF] border border-[#BFC6D4] text-center space-y-1 hover:border-[#1B7A38]/40 transition-all">
              <span className="text-xs font-mono font-bold text-[#1B7A38] block">CMMI & COBIT</span>
              <span className="text-[10px] text-[#475569]">Ingeniería de Software</span>
            </div>
            <div className="p-4 rounded-2xl bg-[#CFD5DF] border border-[#BFC6D4] text-center space-y-1 hover:border-[#1B7A38]/40 transition-all">
              <span className="text-xs font-mono font-bold text-[#1B7A38] block">ITIL v4</span>
              <span className="text-[10px] text-[#475569]">Gestión de Servicios</span>
            </div>
            <div className="p-4 rounded-2xl bg-[#CFD5DF] border border-[#BFC6D4] text-center space-y-1 hover:border-[#1B7A38]/40 transition-all">
              <span className="text-xs font-mono font-bold text-[#1B7A38] block">Scrum / PMI</span>
              <span className="text-[10px] text-[#475569]">Metodología Ágil</span>
            </div>
          </div>
        </div>
      </motion.div>
