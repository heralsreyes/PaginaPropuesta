      ...
      >
        ...
        <div className="w-full space-y-6 pt-4">
          ...
          <div className="w-screen relative left-1/2 right-1/2 -mx-[50vw] overflow-hidden py-6">
            <div className="absolute top-0 left-0 bottom-0 w-24 sm:w-40 bg-gradient-to-r from-[#091C23] via-[#091C23]/90 to-transparent z-20 pointer-events-none" />
            <div className="absolute top-0 right-0 bottom-0 w-24 sm:w-40 bg-gradient-to-l from-[#091C23] via-[#091C23]/90 to-transparent z-20 pointer-events-none" />
