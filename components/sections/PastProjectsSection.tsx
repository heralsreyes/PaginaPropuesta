    ...
    >
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="p-7 rounded-3xl bg-[#ECE7DC] border border-[#DDD7C8] shadow-md shadow-[#1B7A38]/5 hover:border-[#1B7A38]/40 hover:shadow-xl transition-all space-y-4">
        ...
        <div className="w-full space-y-6 pt-4">
          ...
          <div className="w-screen relative left-1/2 right-1/2 -mx-[50vw] overflow-hidden py-6">
            <div className="absolute top-0 left-0 bottom-0 w-24 sm:w-40 bg-gradient-to-r from-[#F7F5EF] via-[#F7F5EF]/90 to-transparent z-20 pointer-events-none" />
            <div className="absolute top-0 right-0 bottom-0 w-24 sm:w-40 bg-gradient-to-l from-[#F7F5EF] via-[#F7F5EF]/90 to-transparent z-20 pointer-events-none" />
            ...
            >
              {marqueeClients.map((client, idx) => (
                <div
                  key={idx}
                  className="w-72 sm:w-80 md:w-[350px] p-6 sm:p-8 rounded-3xl bg-[#ECE7DC] shadow-md shadow-[#1B7A38]/5 border border-[#DDD7C8] flex flex-col items-center justify-center text-center space-y-4 hover:border-[#1B7A38]/40 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group shrink-0 cursor-pointer relative overflow-hidden"
                >
                  <div className="w-48 h-28 sm:w-56 sm:h-32 flex items-center justify-center overflow-hidden bg-[#F7F5EF] border border-[#DDD7C8] rounded-2xl p-4">
                    <img
                      src={client.logo}
                      alt={client.name}
